        ...
        <div class="container justify-content-center d-flex mt-5"> <!-- Container -->
            <div class="row"> <!-- Row -->
                <div class="col-md-6 col-sm-12 mb-5"> <!-- Col -->
                    <div class="card ml-3 mr-3" style="width: 19rem; min-height: 300px;"> <!-- Card -->
                        <img class="card-img-top imgcard" src="images/Valorant.webp"> 
                        <div class="card-body"> <!-- Card Body -->
                            <h5 class="card-title">Jogos</h5>
                            <p class="card-text">Precisa de alguém para jogar junto ou até um boostzinho na conta?</p>
                            <a href="servicos/jogos.php" class="btn btn-primary">Obtenha</a>
                        </div> <!-- /fim card body-->
                    </div> <!-- /fim card -->
                </div> <!-- /fim col -->
                ...
                <div class="col-md-6 col-sm-12 mb-5">
                    <div class="card ml-3 mr-3" style="width: 19rem; min-height: 300px;"> <!-- Card -->
                        <img class="card-img-top imgcard" src="images/teclado.jpg"> 
                        <div class="card-body"> <!-- Card Body -->
                            <h5 class="card-title">Campeonatos</h5>
                            <p class="card-text">Participe de campeonatos de jogos e concorra a prêmios!</p>
                            <a href="servicos/campeonatos.php" class="btn btn-primary">Obtenha</a>
                        </div> <!-- /fim card body-->
                    </div> <!-- /fim card -->
                </div> <!-- /fim col -->
