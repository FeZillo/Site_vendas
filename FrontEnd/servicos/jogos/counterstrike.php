...
<html lang="pt-br">
    <head>
        ...
        <title>Zillo's - Counter-Strike</title>
            ...
            <div class="row"> <!-- Row -->
                <div class="col-md-6 col-sm-12 mb-5">
                    <div class="card ml-3 mr-3 mt-5">
                        <img class="imgcard card-img-top imagem-card" src="../../images/patentes.jpg">
                        <div class="card-body elo-job">
                            ...
                            <a href="eloJob.php?game=counterstrike" class="btn btn-primary">Obtenha!</a> <a href="../../contato.php" class="btn btn-danger">Tire suas Dúvidas</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-12 mb-5">
                    <div class="card ml-3 mr-3 mt-5">
                        <img class="card-img-top imgcard imagem-card" src="../../images/csgo.png" alt="">
                        <div class="card-body jogue-comigo">
                            ...
                            <a href="coach.php?game=counterstrike" class="btn btn-primary botao-abaixo">Obtenha!</a> <a href="../../contato.php" class="btn btn-danger botao-abaixo">Tire suas Dúvidas</a>
                        </div>
                    </div>
                </div>
