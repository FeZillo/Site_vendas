...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container mt-4"> <!-- Container -->
            <div class="row">
                <div class="col-md-3 col-sm-12 bg-danger mr-2 ml-2 mb-4 valorant-card" onclick="vava();">
                    <div class="text">
                        Valorant
                    </div>
                </div>
                <div class="col-md-3 col-sm-12 bg-danger mr-2 ml-2 mb-4 league-card" onclick="lol();">
                    <div class="text">
                        League of Legends
                    </div>
                </div>
                <div class="col-md-3 col-sm-12 bg-danger mr-2 ml-2 mb-4 cs-card" onclick="cs();">
                    <div class="text">
                        Counter-Strike
                    </div>
                </div>
                <div class="col-md-3 col-sm-12 bg-danger mr-2 ml-2 mb-4 dbd-card" onclick="dbd();">
                    <div class="text">
                        Dead By Daylight
                    </div>
                </div>
